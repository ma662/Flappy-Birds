...
function Home() {
  ...
  <div className="container1 backgroundtexture1">
    <div className="row">
      ...
      <div className="col-12 reactlogo">
        <img src="assets/images/React.js_logo-512.png" width="500rem" height="500rem" alt="logo for react"/>
      </div>
        {/* <!-- <div className="col-sm">
      </div> -->  */}
    </div>
  ...
  <div className="mySlides fade">
    <div className="numbertext">1 / 3</div>
      <img src="assets/images/differentbirds.png" style={{'width': '100%'}}/>
  ...
  <div className="container3">
    ...
    <div className="column">
      <div className="card">
        <img src="img1.jpg" alt="Jason Sips" style={{width: '100%'}}/>
  ...
  <div className="column">
    <div className="card">
      <img src="img2.jpg" alt="Myles" style={{width: '100%'}}/>
      <div className="container">
        <h2>Myles </h2>
  ...
  <div className="column">
    <div className="card">
      <img src="img3.jpg" alt="Tristan Martin" style={{width: '100%'}}/>
      <div className="container">
